...
pub use experimental::{
    ...
    get_import_resolver_observer, get_memory_allocator, get_snapshotter, get_yielder,
    ...
    FunctionListenerFn, ImportACL, ImportResolver, ImportResolverConfig, ImportResolverEvent,
    ImportResolverObservation, ImportResolverObserver, InternalFunction, InternalModule,
    IntoCloseNotifier, IntoFuelController, IntoMemoryAllocator, LinearMemory, MemoryAllocator,
    MemoryAllocatorFn, MultiFunctionListenerFactory, ProgramCounter, Resumer,
    SimpleFuelController, Snapshot, Snapshotter, StackFrame, StackIterator, Table, YieldError,
    Yielder,
