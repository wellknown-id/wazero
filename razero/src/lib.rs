...
pub use experimental::{
    ...
    with_trap_observer, with_yield_policy, with_yield_policy_observer, with_yielder,
    AggregatingFuelController, CloseNotifier, CloseNotifyFn, DefaultMemoryAllocator, ErrYielded,
    FrameStackIterator, FuelController, FuelEvent, FuelObservation, FuelObserver, FunctionListener,
    FunctionListenerFactory, FunctionListenerFactoryFn, FunctionListenerFn, HostCallPolicy,
    ...
    TrapObserver, YieldError, YieldPolicy, YieldPolicyDecision, YieldPolicyObservation,
    YieldPolicyObserver, YieldPolicyRequest, Yielder, CORE_FEATURES_EXTENDED_CONST,
