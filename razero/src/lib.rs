...
pub use experimental::{
    ...
    get_fuel_controller, get_import_resolver, get_import_resolver_config,
    ...
    ErrYielded, FrameStackIterator, FuelController, FunctionListener, FunctionListenerFactory,
    FunctionListenerFactoryFn, FunctionListenerFn, ImportACL, ImportResolver, ImportResolverConfig,
    ImportResolverEvent, ImportResolverObservation, ImportResolverObserver, InternalFunction,
    InternalModule, IntoCloseNotifier, IntoFuelController, IntoMemoryAllocator, LinearMemory,
    ...
    TrapObservation, TrapObserver, YieldError, Yielder, CORE_FEATURES_EXTENDED_CONST,
