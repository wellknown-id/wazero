...
mod tests {
    ...
    #[test]
    fn linked_module_rejects_non_integer_data_offset_expression() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
        ...
        assert!(err
            .to_string()
            .contains("offset expression must evaluate to i32/i64"));
    }
    ...
    #[test]
    fn linked_module_rejects_invalid_ref_null_offset_type() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
    ...
    #[test]
    fn linked_module_rejects_truncated_ref_null_offset_expression() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
    ...
    #[test]
    fn linked_module_rejects_multi_value_const_expression() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
        ...
        assert!(err
            .to_string()
            .contains("stack has more than one value at end of constant expression"));
    }
    ...
    #[test]
    fn linked_module_rejects_unsupported_element_initializer_opcode() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
        ...
        assert!(err
            .to_string()
            .contains("element[0].init[0] uses an unsupported initializer opcode 0x41"));
    }
    ...
    #[test]
    fn linked_module_rejects_missing_local_function_in_element_initializer() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
        ...
        assert!(err
            .to_string()
            .contains("element[0].init[0] references missing local function 7"));
    }
    ...
    #[test]
    fn linked_module_rejects_empty_element_initializer() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
        ...
        assert!(err.to_string().contains("element[0].init[0] is empty"));
    }
    ...
    #[test]
    fn linked_module_rejects_invalid_ref_null_element_initializer() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
        ...
        assert!(err
            .to_string()
            .contains("element[0].init[0] has an invalid ref.null encoding"));
    }
    ...
    #[test]
    fn linked_module_rejects_ref_func_initializer_with_trailing_bytes() {
        let mut engine = CompilerEngine::new();
        let module = Module {
            type_section: vec![function_type(&[], &[ValueType::I32])],
            function_section: vec![0],
