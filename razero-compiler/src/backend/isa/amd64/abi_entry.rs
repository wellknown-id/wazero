pub const ENTRYPOINT_SYMBOL: &str = "razero_amd64_entrypoint";
...
core::arch::global_asm!(include_str!("abi_entry.S"), options(att_syntax));

#[cfg(target_arch = "x86_64")]
unsafe extern "C" {
    pub fn razero_amd64_entrypoint(
    ...
    pub fn razero_amd64_after_go_function_call_entrypoint(
        executable: *const u8,
        execution_context_ptr: usize,
        stack_pointer: usize,
        frame_pointer: usize,
