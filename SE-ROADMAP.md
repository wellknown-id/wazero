...
| 7. Rust-port AOT packaging and native distribution  | —                                                                                                                                                    | [99%:4c1c495b] Strong Linux ELF/AOT packaging path exists, and package-bundle deserialization now has core negative coverage for invalid magic, truncated headers and numeric fields, truncated module sidecars, truncated host-import count and type-index fields, and unexpected trailing bytes; broader runtime-state packaging hardening still remains. |
