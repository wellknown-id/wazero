...
| 7. Rust-port AOT packaging and native distribution  | —                                                                                                                                                    | [98%:1870475c] Strong Linux ELF/AOT packaging path exists, and package-bundle deserialization now has core negative coverage for invalid magic, truncated headers and numeric fields, truncated module sidecars, truncated host-import count and fields, and unexpected trailing bytes; broader runtime-state packaging hardening still remains. |
