...
| 7. Rust-port AOT packaging and native distribution  | —                                                                                                                                                    | [95%:ea77dc43] Strong Linux ELF/AOT packaging path exists; generic host-import/runtime-state packaging still needs hardening. |
