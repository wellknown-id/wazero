...
- [88%:16b42271] Add targeted tests for memory fault recovery, fuel exhaustion, async resumption, and policy enforcement, with public runtime coverage now also checking import-resolver observer ordering for ACL allow/deny, resolver success, store fallback, and fail-closed denial.
